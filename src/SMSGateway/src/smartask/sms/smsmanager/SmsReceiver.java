...
/**
 * This class implements the BroadcasrReceiver that is registered to receive SMS
 * parts and joins them. When the full message is received, an instance of
 * TreatSMSThread is created and the corresponding service is called.
 * 
 * @author Grupo 1
 */
